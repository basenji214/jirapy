"""
Django settings for jirawal_prj project.
...
SECRET_KEY = 'django-insecure-v(u_@srs_l*##n+@qlf4x)q8n6lb31en3(2v2bo$=j%)f9fjus'
...
WSGI_APPLICATION = 'jirawal_prj.wsgi.application'
